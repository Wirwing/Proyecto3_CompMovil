...
public class DropboxAPIFactory {
	...
	/**
	 * Obtiene un objeto DropboxAPI con una sesión con los tokens
	 * proporcionados como parámetro
	 * @param key token key
	 * @param secret token secret
	 * @return
	 */
	public static DropboxAPI<AndroidAuthSession> getDropboxAPI(String key, String secret){
